# Contributing to Hubble Thingy53 Reference Application

Thank you for your interest in contributing to the Hubble Thingy53 Reference Application.

This document outlines the contribution guidelines and processes for the Hubble Thingy53 Reference Application.
Following these guidelines helps ensure consistency, quality, and maintainability
...
- Search existing [Issues](https://github.com/hubblenetwork/hubble-reference-thingy53/issues)

If you still have questions, please start a discussion in [GitHub Discussions](https://github.com/hubblenetwork/hubble-reference-thingy53/discussions).
...
The Hubble Thingy53 Reference Application uses the Apache 2.0
license. All contributions must be compatible with this license. Each
source file must include the SPDX license identifier:
...
- Check if there is already a bug report for your issue in the
  [bug tracker](https://github.com/hubblenetwork/hubble-reference-thingy53/issues?q=label%3Abug)
...
- Open a [Bug Report](https://github.com/hubblenetwork/hubble-reference-thingy53/issues/new/choose)
...
- Search existing [Issues](https://github.com/hubblenetwork/hubble-reference-thingy53/issues) to see
...
```
app: Toggle bluetooth using hw button

Add support to toggle bluetooth advertisement using
the physical button.
...
- Include headers in this order:
  ...
  3. Hubble SDK headers (`<hubble/port/sys.h>`, etc.)
...
- Check existing [GitHub Discussions](https://github.com/hubblenetwork/hubble-reference-thingy53/discussions)
- Start a new discussion in [GitHub Discussions](https://github.com/hubblenetwork/hubble-reference-thingy53/discussions)
